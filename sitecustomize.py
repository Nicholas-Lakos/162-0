...
Python imports sitecustomize automatically during startup, so this keeps the live
service in sync even when Render's existing service build command is managed
outside render.yaml.
"""
